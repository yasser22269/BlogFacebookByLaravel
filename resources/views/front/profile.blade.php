...
<section>
    <div class="feature-photo">
        <figure><img src="{{asset('/front/')}}/images/resources/timeline-1.jpg" alt=""></figure>
        <div class="add-btn">
            <span>{{$Userfriends->count()}} Friends</span>
            @if( $route_parameter != auth()->user()->user_name)
                @if ( $friends == null )
                <a href="#" title="" data-ripple="">Add Friend </a> 
                @else
                <a href="#" title="" data-ripple="">{{$friends->friends_request}} </a> 
                @endif
            @endif
        </div>
                        ...
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                ...
                                <div class="widget stick-widget">
                                    ...
                                    <ul class="followers ps-container ps-theme-default ps-active-y" data-ps-id="8f8e574a-8d8b-b509-1a46-61bdb554ce4f">
                                        <li>
                                            <figure><img src="{{asset('/front/')}}/images/resources/friend-avatar2.jpg" alt=""></figure>
                                        ...
                                        <li>
                                            <figure><img src="{{asset('/front/')}}/images/resources/friend-avatar4.jpg" alt=""></figure>
                                            <div class="friend-meta">
                                        ...
                                        <li>
                                            <figure><img src="{{asset('/front/')}}/images/resources/friend-avatar6.jpg" alt=""></figure>
                                            <div class="friend-meta">
                                        ...
                                        <li>
                                            <figure><img src="{{asset('/front/')}}/images/resources/friend-avatar8.jpg" alt=""></figure>
                                            <div class="friend-meta">
                                        ...
                                        <li>
                                            <figure><img src="{{asset('/front/')}}/images/resources/friend-avatar3.jpg" alt=""></figure>
                                            <div class="friend-meta">
                            ...
                            <div class="loadMore">
                                <div class="central-meta item" style="display: inline-block;">
                                    <div class="new-postbox">
                                        <figure>
                                            <img src="{{asset('/front/')}}/images/resources/admin2.jpg" alt="">
                                        </figure>
                                ...
                                <div class="central-meta item" style="display: inline-block;">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar10.jpg" alt="">
                                            </figure>
                                            ...
                                            <div class="post-meta">
                                                <div class="linked-image align-left">
                                                    <a href="#" title=""><img src="{{asset('/front/')}}/images/resources/page1.jpg" alt=""></a>
                                                </div>
                                                <div class="detail">
                                ...
                                <div class="central-meta item" style="display: inline-block;">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            ...
                                            <div class="post-meta">
                                                <img src="{{asset('/front/')}}/images/resources/user-post.jpg" alt="">
                                                <div class="we-video-info">
                                                    <ul>
                                            ...
                                            <ul class="we-comet">
                                                <li>
                                                    <div class="comet-avatar">
                                                        <img src="{{asset('/front/')}}/images/resources/comet-1.jpg" alt="">
                                                    </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div class="comet-avatar">
                                                                <img src="{{asset('/front/')}}/images/resources/comet-2.jpg" alt="">
                                                            </div>
                                                            <div class="we-comment">
                                                                <div class="coment-head">
                                                        ...
                                                        <li>
                                                            <div class="comet-avatar">
                                                                <img src="{{asset('/front/')}}/images/resources/comet-3.jpg" alt="">
                                                            </div>
                                                            <div class="we-comment">
                                                                <div class="coment-head">
                                ...
                                <div class="central-meta item" style="display: none;">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            ...
                                            <div class="post-meta">
                                                <iframe src="{{asset('/front/')}}/https://player.vimeo.com/video/15232052" height="315" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
                                                <div class="we-video-info">
                                                    <ul>
                        ...
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                ...
                                <div class="widget friend-list stick-widget" style="">
                                    ...
                                    <ul id="people-list" class="friendz-list ps-container ps-theme-default ps-active-y" data-ps-id="fae3f4f7-8ea1-db32-9aab-c5704e4f0977">
                                        <li>
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar.jpg" alt="">
                                        ...
                                        <li>
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar2.jpg" alt="">
                                        ...
                                        <li>
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar3.jpg" alt="">
                                        ...
                                        <li>
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar4.jpg" alt="">
                                                <span class="status f-off"></span>
                                            </figure>
                                            <div class="friendz-meta">
                                        ...
                                        <li>
                                            ...
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar5.jpg" alt="">
                                                <span class="status f-online"></span>
                                            </figure>
                                            <div class="friendz-meta">
                                        ...
                                        <li>
                                            ...
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar6.jpg" alt="">
                                                <span class="status f-away"></span>
                                            </figure>
                                            <div class="friendz-meta">
                                        ...
                                        <li>
                                            ...
                                            <figure>
                                                <img src="{{asset('/front/')}}/images/resources/friend-avatar7.jpg" alt="">
                                                <span class="status f-off"></span>
                                            </figure>
                                            <div class="friendz-meta">
                                    ...
                                    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 450px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 358px;"></div></div></ul>
                                    <div class="chat-box">
                                        <div class="chat-head">
                                            <span class="status f-online"></span>
                                            <h6>Bucky Barnes</h6>
                                        ...
                                        <div class="chat-list">
                                            <ul class="ps-container ps-theme-default ps-active-y" data-ps-id="394d336e-6f28-8b1d-1129-ae70a87c62a2">
                                                <li class="me">
                                                    <div class="chat-thumb"><img src="{{asset('/front/')}}/images/resources/chatlist1.jpg" alt=""></div>
                                                ...
                                                <li class="you">
                                                    <div class="chat-thumb"><img src="{{asset('/front/')}}/images/resources/chatlist2.jpg" alt=""></div>
                                                    <div class="notification-event">
                                                        <span class="chat-message-item">
                                                            Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks
                                                        </span>
                                            ...
                                            <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 290px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 189px;"></div></div></ul>
                                            <form class="text-box">
